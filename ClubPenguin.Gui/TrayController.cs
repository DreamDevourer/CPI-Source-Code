...
public class TrayController : MonoBehaviour
{
	...
	public void OnTrayButtonClicked(Button button)
	{
		...
		{
			closeTray(areControlsVisible: true, isPersistent: true);
		}
	}
	...
	{
		adjustTray(normalizedKeyboardHeight, doneAdjusting: true);
