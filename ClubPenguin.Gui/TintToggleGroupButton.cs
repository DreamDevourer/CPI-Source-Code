...
public class TintToggleGroupButton : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		{
			TintToggleGroupButton[] componentsInChildren = base.transform.parent.GetComponentsInChildren<TintToggleGroupButton>(includeInactive: true);
	...
	public void OnClick()
	{
		...
		{
			componentsInChildren[i].SetTint(on: false);
		}
		SetTint(on: true);
	}
