// PropertyCustomizationController
using ClubPenguin;
...
public class PropertyCustomizationController : MonoBehaviour
{
	...
	public void OnBackButton()
	{
		...
		{
			CustomizationContext.EventBus.DispatchEvent(new CustomizerUIEvents.BackButtonClickedEvent(showConfirmation: true));
		}
	}
	...
	private bool onScaleChanged(CustomizerWidgetEvents.SliderWidgetValueChanged evt)
	{
		...
		float num = convertSliderScale(value, fromSlider: true);
	...
	private void updateToolSettings()
	{
		...
		if (flag)
		{
			...
			CustomizationContext.EventBus.DispatchEvent(new CustomizerWidgetEvents.SetSliderWidgetValue(convertSliderScale(scale, fromSlider: false)));
