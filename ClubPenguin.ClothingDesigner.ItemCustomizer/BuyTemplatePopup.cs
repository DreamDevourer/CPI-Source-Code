...
public class BuyTemplatePopup : MonoBehaviour
{
	...
	{
		removeListeners();
		CoroutineRunner.Start(delayedHideAnimation(isDismissed: false), this, "delayedHideAnimation");
	}

	private void onDismissButton()
	{
		removeListeners();
		CoroutineRunner.Start(delayedHideAnimation(isDismissed: true), this, "delayedHideAnimation");
	}
