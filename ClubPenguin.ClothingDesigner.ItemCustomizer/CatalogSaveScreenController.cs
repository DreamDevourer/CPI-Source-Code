...
public class CatalogSaveScreenController : MonoBehaviour
{
	...
	public void OnSubmitItem()
	{
		...
		ClothingDesignerContext.EventBus.DispatchEvent(new ClothingDesignerUIEvents.UpdateCameraState(ClothingDesignerCameraState.CatalogSave, animateCamera: true));
	}
