...
public class PenguinRotationAnimate : MonoBehaviour
{
	...
	public bool isAtRest => rotateSpring.isAtRest;
	...
	private void setCurrentRotationPreventingGimbalLock()
	{
		...
		rotateSpring.SetSpringGoal(num, instant: true);
	}

	public void OffsetRotation(float degrees)
	{
		StopForces();
		rotateSpring.SetSpringGoal(rotateSpring.springValue + degrees, instant: true);
