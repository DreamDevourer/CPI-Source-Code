// FurnitureTemplateSelectionController
using ClubPenguin;
...
public class FurnitureTemplateSelectionController : TemplateSelectionController
{
	...
	public void Start()
	{
		templateCategoryButtons = TemplateNavContentPanel.gameObject.GetComponentsInChildren<FurnitureTemplateCategoryButton>(includeInactive: true);
