...
public class SessionStarter : ISessionStarter
{
	...
	{
		CreateDependencies(guestControllerHostUrl, guestControllerSpoofedIpAddress, mixApiHostUrl, oneIdClientId, mixClientToken, clientVersion, coroutineManager, keychain, logger, localStorageDirPath, languageCode, out ISessionLogin sessionLogin, out ISessionRegister _, out ISessionRestorer _, out ISessionReuser _, out IOfflineSessionCreator _);
	...
	{
		CreateDependencies(guestControllerHostUrl, guestControllerSpoofedIpAddress, mixApiHostUrl, oneIdClientId, mixClientToken, clientVersion, coroutineManager, keychain, logger, localStorageDirPath, languageCode, out ISessionLogin _, out ISessionRegister sessionRegister, out ISessionRestorer _, out ISessionReuser _, out IOfflineSessionCreator _);
	...
	{
		CreateDependencies(guestControllerHostUrl, guestControllerSpoofedIpAddress, mixApiHostUrl, oneIdClientId, mixClientToken, clientVersion, coroutineManager, keychain, logger, localStorageDirPath, languageCode, out ISessionLogin _, out ISessionRegister _, out ISessionRestorer sessionRestorer, out ISessionReuser _, out IOfflineSessionCreator _);
	...
	{
		CreateDependencies(guestControllerHostUrl, guestControllerSpoofedIpAddress, mixApiHostUrl, oneIdClientId, mixClientToken, clientVersion, coroutineManager, keychain, logger, localStorageDirPath, languageCode, out ISessionLogin _, out ISessionRegister _, out ISessionRestorer _, out ISessionReuser sessionReuser, out IOfflineSessionCreator _);
