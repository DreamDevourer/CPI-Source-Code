...
public class RemotePenguinInteraction : AbstractPenguinInteraction
{
	...
	public void OnTriggerEnter(Collider collider)
	{
		...
		if (gameObject != null && AvatarDataHandle.TryGetPlayerHandle(base.gameObject, out DataEntityHandle _) && canInteractWithActionGraph(gameObject))
		{
