...
public class PenguinInteraction : AbstractPenguinInteraction
{
	...
	private ParticipationData participationData => participationController.GetParticipationData();
	...
	public void OnTriggerEnter(Collider collider)
	{
		...
		if (!AvatarDataHandle.TryGetPlayerHandle(base.gameObject, out DataEntityHandle _) || !(gameObject != null) || !canInteractWithActionGraph(gameObject))
		{
			return;
		}
	...
	{
		if (AvatarDataHandle.TryGetPlayerHandle(base.gameObject, out DataEntityHandle _) && participationData.CurrentParticipationState == ParticipationState.Pending)
		{
