...
public class AudioScreenController : AbstractIglooScreenController<MusicTrackDefinition, int>
{
	...
	{
		return ProgressionUtils.RetrieveProgressionLockedItems<MusicTrackDefinition, MusicTrackRewardDefinition>(ProgressionUnlockCategory.musicTracks, AbstractStaticGameDataRewardDefinition<MusicTrackDefinition>.ToDefinitionArray<MusicTrackRewardDefinition>);
	}
