...
public class LotsScreenController : AbstractIglooScreenController<LotDefinition, string>
{
	...
	{
		return ProgressionUtils.RetrieveProgressionLockedItems<LotDefinition, LotRewardDefinition>(ProgressionUnlockCategory.lots, AbstractStaticGameDataRewardDefinition<LotDefinition>.ToDefinitionArray<LotRewardDefinition>);
	}
