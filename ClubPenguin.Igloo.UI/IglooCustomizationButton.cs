...
public class IglooCustomizationButton : CustomizationButton, IBeginDragHandler, IDragHandler, IEndDragHandler, ICancelHandler, IEventSystemHandler, ILockableButton
{
	...
	public void SetupItemButton()
	{
		CanSelect = true;
		SetCanDrag();
		itemContentContainer.SetActive(value: true);
		catalogButtonContainer.SetActive(value: false);
	}
	...
	{
		ClubPenguin.SceneRefs.FullScreenPopupManager.CreatePopup(IglooCatalogPrefabKey, null, useCameraSpace: false, OnCatalogPrefabInstantiated);
	...
	public void SetUnlocked()
	{
		...
		{
			sizeLockBadge.SetActive(value: false);
		}
	}
	...
	public void SetMemberLocked()
	{
		...
		progressionBadge.SetActive(value: false);
		mascotBadges.SetActive(value: false);
		memberlockBadge.SetActive(value: true);
		if (sizeLockBadge != null)
		{
			sizeLockBadge.SetActive(value: false);
		}
	...
	public void SetSizeLocked()
	{
		...
		SetCanDrag(drag: false);
		materialSelector.SelectMaterial(1);
		itemCountPanel.SetActive(value: true);
		progressionBadge.SetActive(value: false);
		mascotBadges.SetActive(value: false);
		memberlockBadge.SetActive(value: false);
		if (sizeLockBadge != null)
		{
			sizeLockBadge.SetActive(value: true);
		}
	}
