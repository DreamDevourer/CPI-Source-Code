...
public class LightingScreenController : AbstractIglooScreenController<LightingDefinition, int>
{
	...
	{
		return ProgressionUtils.RetrieveProgressionLockedItems<LightingDefinition, LightingRewardDefinition>(ProgressionUnlockCategory.lighting, AbstractStaticGameDataRewardDefinition<LightingDefinition>.ToDefinitionArray<LightingRewardDefinition>);
	}
