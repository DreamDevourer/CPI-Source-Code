...
public static class AdventureReminderTutorial
{
	...
	{
		if (Service.Get<GameStateController>().IsFTUEComplete && PlayerPrefs.GetInt("adventure_reminder_tutorial_shown_" + mascotName) != 1 && PlayerPrefs.HasKey("available_adventure_timestamp_" + mascotName) && long.TryParse(PlayerPrefs.GetString("available_adventure_timestamp_" + mascotName), out long result))
		{
