...
public class VisibilityRegion : MonoBehaviour
{
	...
	public Bounds Bounds => new Bounds(base.transform.position, base.transform.localScale);

	public Vector3 WorldSpaceDirection => GetVisibilityDirection().TransformRef.forward;
