...
public class FindFourBoard : MonoBehaviour
{
	...
	public int CurrentTokenColumn => currentTokenColumn;
	...
	private IEnumerator showWinEffects()
	{
		...
		{
			GameObject effect = UnityEngine.Object.Instantiate(winHighlightEffectPrefab, TokenContainer.transform, worldPositionStays: false);
