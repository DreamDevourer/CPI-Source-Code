...
public class FindFourPlayerHud : MonoBehaviour
{
	...
	{
		TokenSpriteSelector.gameObject.SetActive(value: false);
		TimerObject.SetActive(value: true);
		Timer.StartCountdown(time);
	}

	public void StopTimer()
	{
		TokenSpriteSelector.gameObject.SetActive(value: true);
		TimerObject.SetActive(value: false);
		Timer.StopCountdown();
	}
}
