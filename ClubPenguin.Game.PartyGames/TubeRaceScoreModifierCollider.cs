...
public class TubeRaceScoreModifierCollider : MonoBehaviour
{
	...
	{
		Service.Get<EventDispatcher>().DispatchEvent(new PlayerIndicatorEvents.RemovePlayerIndicator(Service.Get<CPDataEntityCollection>().LocalPlayerSessionId, isStored: false));
