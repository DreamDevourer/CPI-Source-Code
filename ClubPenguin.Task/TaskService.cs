...
public class TaskService
{
	...
	public IEnumerable<Task> Tasks => tasks.Values;
	...
	public void SetTaskProgress(string taskId, int count, bool? claimed = default(bool?))
	{
	...
	private void setTaskProgress(Task task, int count, bool? claimed = default(bool?))
	{
