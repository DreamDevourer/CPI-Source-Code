...
public class JigsawBackground : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		dispatcher.AddListener<JigsawEvents.PieceSolveComplete>(onPieceSolveEffectsComplete);
	...
	{
		dispatcher.RemoveListener<JigsawEvents.PieceSolveComplete>(onPieceSolveEffectsComplete);
	}
	...
	private bool onPieceSolveEffectsComplete(JigsawEvents.PieceSolveComplete e)
	{
	...
	private IEnumerator AllEffectsComplete()
	{
		...
		dispatcher.DispatchEvent(default(JigsawEvents.BackgroundSolveComplete));
	}
}
