...
public class WarpAlongPathPrimitive : LocomotionPrimitive
{
	...
	private void OnDestroy()
	{
		...
		{
			anim.SetBool(animBoolParameter, value: false);
		}
	}
	...
	public void SetData(WarpAlongPathPrimitiveData data)
	{
		if (data != null)
		{
			...
			if (!string.IsNullOrEmpty(mutableData.AnimBool))
			{
				...
				anim.SetBool(animBoolParameter, value: true);
			}
		}
	}
	...
	private void calculateSplines()
	{
		...
		if (waypoints == null)
		{
			Transform[] componentsInChildren = mutableData.Waypoints.GetComponentsInChildren<Transform>(includeInactive: true);
