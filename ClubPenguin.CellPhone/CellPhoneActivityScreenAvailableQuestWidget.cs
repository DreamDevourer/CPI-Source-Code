// CellPhoneActivityScreenAvailableQuestWidget
using ClubPenguin;
...
public class CellPhoneActivityScreenAvailableQuestWidget : MonoBehaviour, ICellPhoneAcitivtyScreenWidget
{
	...
	{
		if (quest.CompleteReward.ToReward().TryGetValue(out CoinReward rewardable))
		{
		...
		if (quest.CompleteReward.ToReward().TryGetValue(out MascotXPReward rewardable2))
		{
