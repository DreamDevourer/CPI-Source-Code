...
public class ParticipationCompetitionRules : CompetitionRules<GameObject>
{
	...
	public override void AssignPointsToCompetitors(List<Competitor<GameObject>> competitors)
	{
		for (int i = 0; i < competitors.Count; i++)
		{
			...
			if (DataEntityCollection.TryGetComponent(PlayerHandle, out GameObjectReferenceData component4))
			{
	...
	{
		if (DataEntityCollection.TryGetComponent(PlayerHandle, out SessionIdData component))
		{
