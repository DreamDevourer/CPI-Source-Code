...
public class BlockAndLockSettings : MonoBehaviour
{
	...
	private void CalculateGrid()
	{
		...
		{
			Log.LogError(null, $"O_o\t BlockAndLockSettings.Start: ERROR -- GridTopLeft marker needs to be set");
			return;
		}
		if (MarkerBottomRight == null)
		{
			Log.LogError(null, $"O_o\t BlockAndLockSettings.Start: ERROR -- GridBottomRight marker needs to be set");
			return;
		}
