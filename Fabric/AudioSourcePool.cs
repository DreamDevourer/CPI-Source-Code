...
public class AudioSourcePool : MonoBehaviour
{
	...
	public void Refresh()
	{
		AudioVoice[] componentsInChildren = base.gameObject.GetComponentsInChildren<AudioVoice>(includeInactive: true);
	...
	public void Resize(int count)
	{
		...
		{
			AudioVoice[] componentsInChildren = GetComponentsInChildren<AudioVoice>(includeInactive: true);
