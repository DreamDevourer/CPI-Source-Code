...
public class GroupComponent : Fabric.Component
{
	private bool _solo;
	...
	{
		if (base.transform.parent != null && (base.transform.parent.gameObject.GetComponent<FabricManager>() != null || base.transform.parent.gameObject.GetComponent<Fabric.Component>() != null))
		{
			return true;
		}
		return false;
	...
	{
		if (!Fabric.Component._initializationInProgress && !(FabricManager.Instance == null) && !IsFabricHierarchyPresent() && !_isInstance)
		{
			if (_eventEditor != null)
			{
