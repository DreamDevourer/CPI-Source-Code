...
public class EventEditor
{
	...
	{
		[NonSerialized]
		private Fabric.Event _runtimeEvent = new Fabric.Event();

		[SerializeField]
		public Fabric.Event _event = new Fabric.Event();

		[SerializeField]
		public Fabric.Component _component;
	...
	public class EventEntry : IEventListener
	{
		...
		[NonSerialized]
		private List<Fabric.Event> _eventQueue = new List<Fabric.Event>();
		...
		private System.Random rnd => Generic._random;
		...
		public bool IsComponentPresent(Fabric.Component component)
		{
	...
	[NonSerialized]
	private Fabric.Component _cachedComponent;
	...
	public void RemoveComponent(Fabric.Component component)
	{
