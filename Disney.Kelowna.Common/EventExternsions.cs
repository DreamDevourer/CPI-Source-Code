...
public static class EventExternsions
{
	...
	{
		e.InvokeSafe(EventExternsions.invokeActionOneArg<T>, arg1);
	}
	...
	{
		e.InvokeSafe(EventExternsions.invokeActionTwoArg<T, U>, arg1, arg2);
	}
	...
	{
		e.InvokeSafe(EventExternsions.invokeActionThreeArg<T, U, V>, arg1, arg2, arg3);
	}
