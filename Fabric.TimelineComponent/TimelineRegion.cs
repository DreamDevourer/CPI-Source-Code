...
[AddComponentMenu("")]
public class TimelineRegion : Fabric.Component
{
	[SerializeField]
	[HideInInspector]
	...
	[HideInInspector]
	[SerializeField]
	public Fabric.TimelineComponent.Envelope _volumeEnvelope = new Fabric.TimelineComponent.Envelope();
	...
	public void ResetVolumeEnvelope()
	{
		...
		{
			_volumeEnvelope._points = new Fabric.TimelineComponent.Point[4];
			_volumeEnvelope._points[0] = Fabric.TimelineComponent.Point.Alloc(_x, 0f, _fadeInType);
			_volumeEnvelope._points[1] = Fabric.TimelineComponent.Point.Alloc(_x, 1f, _fadeInType);
			_volumeEnvelope._points[2] = Fabric.TimelineComponent.Point.Alloc(_x + _width, 1f, _fadeOutType);
			_volumeEnvelope._points[3] = Fabric.TimelineComponent.Point.Alloc(_x + _width, 0f, _fadeOutType);
		}
