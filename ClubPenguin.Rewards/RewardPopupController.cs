...
public class RewardPopupController : MonoBehaviour
{
	...
	public DRewardPopup PopupData => popupData;
	...
	{
		if (ClubPenguin.SceneRefs.ZoneLocalPlayerManager != null && ClubPenguin.SceneRefs.ZoneLocalPlayerManager.LocalPlayerGameObject != null)
		{
	...
	{
		MascotXPReward rewardable = default(MascotXPReward);
