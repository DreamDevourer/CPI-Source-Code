...
public class CollectibleController : MonoBehaviour
{
	...
	private void Awake()
	{
		ClubPenguin.SceneRefs.SetCollectibleController(this);
	...
	{
		Service.Get<CPDataEntityCollection>()?.EventDispatcher.RemoveListener<DataEntityEvents.ComponentAddedEvent<InZoneCollectiblesData>>(onInZoneCollectiblesDataAdded);
	}
