...
internal class ParentGateGenerator
{
	...
	{
		Service.Get<ICommonGameSettings>().RegisterSetting(parentGateVersion, canBeReset: true);
	}
	...
	public void resetAlgebraQuestion()
	{
		...
		case 1:
			d = a * b + c;
			question = a.ToString() + "x + " + c.ToString() + " = " + d.ToString();
			answer = b;
			break;
		case 2:
			d = a * b - c;
		...
		case 3:
			d = a * b + c;
			question = a.ToString() + " * " + b.ToString() + " + x  = " + d.ToString();
			answer = c;
			break;
		case 4:
			d = a * b - c;
		...
		case 5:
			d = a * b + c;
			question = a.ToString() + " * " + b.ToString() + " + " + c.ToString() + " = x";
			answer = d;
			break;
		default:
			d = a * b - c;
