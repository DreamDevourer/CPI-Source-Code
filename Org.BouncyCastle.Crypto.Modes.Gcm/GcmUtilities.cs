...
internal abstract class GcmUtilities
{
	...
	internal static void MultiplyP(uint[] x)
	{
		...
		uint[] array;
		(array = x)[0] = (uint)((int)array[0] ^ ((int)num & -520093696));
	}
	...
	internal static void MultiplyP(uint[] x, uint[] z)
	{
		...
		uint[] array;
		(array = z)[0] = (uint)((int)array[0] ^ ((int)num & -520093696));
	}
	...
	internal static void Xor(byte[] x, byte[] y)
	{
		...
		do
		{
			...
			array2[num2] = (byte)(array[(long)intPtr] ^ y[num]);
			num++;
			byte[] array3 = array = x;
			int num3 = num;
			intPtr = (IntPtr)num3;
			array3[num3] = (byte)(array[(long)intPtr] ^ y[num]);
			num++;
			byte[] array4 = array = x;
			int num4 = num;
			intPtr = (IntPtr)num4;
			array4[num4] = (byte)(array[(long)intPtr] ^ y[num]);
			num++;
			byte[] array5 = array = x;
			int num5 = num;
			intPtr = (IntPtr)num5;
			array5[num5] = (byte)(array[(long)intPtr] ^ y[num]);
			num++;
		}
		while (num < 16);
	}
	...
	internal static void Xor(byte[] x, byte[] y, int yOff, int yLen)
	{
		while (--yLen >= 0)
		{
			...
			array2[num] = (byte)(array[(long)intPtr] ^ y[yOff + yLen]);
		}
	}
