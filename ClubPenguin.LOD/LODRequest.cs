...
public class LODRequest : MonoBehaviour
{
	...
	public bool CanBeSpawned => !ObjectGenerated && !BeingProcessed && !IsPaused && TotalWeighting >= 0f;

	public bool CanBeRevoked => ObjectGenerated && !BeingProcessed;

	public bool ObjectGenerated => lodGameObjectReference != null;
