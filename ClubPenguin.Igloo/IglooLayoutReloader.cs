...
internal class IglooLayoutReloader : MonoBehaviour
{
	...
	private void sendNotification(string notice, string countDown)
	{
		...
		eventDispatcher.DispatchEvent(new IglooUIEvents.ShowNotification(translatedText, CountDownSeconds, NotificationPrefab, adjustRectPositionForNotification: true, showAfterSceneLoad: false));
	}
