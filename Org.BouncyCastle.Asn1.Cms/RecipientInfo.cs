	...
	public DerInteger Version
	{
		get
		{
			if (info is Asn1TaggedObject)
			{
				...
				{
				case 1:
					return KeyAgreeRecipientInfo.GetInstance(asn1TaggedObject, explicitly: false).Version;
				case 2:
					return GetKekInfo(asn1TaggedObject).Version;
				case 3:
					return PasswordRecipientInfo.GetInstance(asn1TaggedObject, explicitly: false).Version;
				case 4:
	...
	public Asn1Encodable Info
	{
		get
		{
			if (info is Asn1TaggedObject)
			{
				...
				{
				case 1:
					return KeyAgreeRecipientInfo.GetInstance(asn1TaggedObject, explicitly: false);
				case 2:
					return GetKekInfo(asn1TaggedObject);
				case 3:
					return PasswordRecipientInfo.GetInstance(asn1TaggedObject, explicitly: false);
				case 4:
					return OtherRecipientInfo.GetInstance(asn1TaggedObject, explicitly: false);
				default:
					throw new InvalidOperationException("unknown tag");
				}
			}
