...
public class AgeBandBuilder : IAgeBandBuilder
{
	...
	{
		GetConfigurationAgeBand(siteConfig, null, age, out ConfigurationAgeBand configurationAgeBand, out string configurationAgeBandKey);
	...
	{
		if (requirements.TryGetValue(key, out FieldRequirements value) && value.required)
		{
