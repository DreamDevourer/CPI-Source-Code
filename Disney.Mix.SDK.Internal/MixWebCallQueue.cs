...
public class MixWebCallQueue : IMixWebCallQueue
{
	...
	{
		HandleRefreshResult(needAuthToken: true, guestControllerAccessToken, needSession: false, null);
	}

	public void HandleGuestControllerTokenRefreshFailure()
	{
		HandleRefreshResult(needAuthToken: true, null, needSession: false, null);
	}

	public void HandleSessionRefreshSuccess(IWebCallEncryptor encryptor)
	{
		HandleRefreshResult(needAuthToken: false, null, needSession: true, encryptor);
	}

	public void HandleSessionRefreshFailure()
	{
		HandleRefreshResult(needAuthToken: false, null, needSession: true, null);
	}

	public void HandleCombinedRefreshSuccess(string guestControllerAccessToken, IWebCallEncryptor encryptor)
	{
		HandleRefreshResult(needAuthToken: true, guestControllerAccessToken, needSession: true, encryptor);
	}
