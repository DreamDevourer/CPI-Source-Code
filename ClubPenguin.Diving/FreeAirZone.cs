...
public class FreeAirZone : MonoBehaviour
{
	...
	private void OnTriggerEnter(Collider collider)
	{
		...
		{
			dispatcher.DispatchEvent(new DivingEvents.FreeAirEffects(enabled: true, "Player"));
		}
	}
	...
	private void OnTriggerExit(Collider collider)
	{
		...
		if (dispatcher != null && collider.gameObject.CompareTag("Player"))
		{
			dispatcher.DispatchEvent(new DivingEvents.FreeAirEffects(enabled: false, "Player"));
		}
	}
