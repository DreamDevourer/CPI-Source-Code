...
public class BotManager : MonoBehaviour
{
	...
	private Vector3 GetRandomPosition()
	{
		...
		do
		{
			a = new Vector3(Random.value, Random.value, Random.value);
		}
		while (a.x + a.y + a.z == 0f);
		a /= a.x + a.y + a.z;
		Vector3 a2 = navMesh.vertices[navMesh.triangles[num2 * 3]];
		Vector3 a3 = navMesh.vertices[navMesh.triangles[num2 * 3 + 1]];
		Vector3 a4 = navMesh.vertices[navMesh.triangles[num2 * 3 + 2]];
		return a2 * a.x + a3 * a.y + a4 * a.z;
	}
