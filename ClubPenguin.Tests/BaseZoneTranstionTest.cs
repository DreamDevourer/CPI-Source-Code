...
public abstract class BaseZoneTranstionTest : BaseIntegrationTest
{
	...
	public void initNetworkServices()
	{
		...
		NetworkServicesManager networkServicesManager2 = (NetworkServicesManager)(swappableNetworkServicesManager.NetworkServicesManager = new NetworkServicesManager(this, NetworkController.GenerateNetworkServiceConfig(Environment), offlineMode: false));
	}
