...
public class InputHoldButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IEventSystemHandler
{
	...
	public void OnPointerDown(PointerEventData data)
	{
		if (button.IsInteractable() && !buttonDown)
		{
			holdTime = 0f;
			buttonDown = true;
			dispatcher.DispatchEvent(new InputEvents.ChargeActionEvent(Action, _buttonState: true, holdTime));
		}
	}
	...
	{
		dispatcher.DispatchEvent(new InputEvents.ChargeActionEvent(Action, _buttonState: false, _holdTime));
		buttonDown = false;
	}
