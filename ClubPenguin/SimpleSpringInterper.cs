...
public class SimpleSpringInterper : MonoBehaviour
{
	...
	public bool isAtRest => _activeRoutine == null;

	public float springGoal => _springGoal;
	...
	private void Cache()
	{
		if (!_inited)
		{
			...
			SetSpringGoal(startingGoal, instant: true);
		}
	}
