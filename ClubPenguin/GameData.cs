...
public class GameData : IGameData
{
	...
	public TDefinition GetDefinitionById<TDefinition, TId>(TypedStaticGameDataKey<TDefinition, TId> staticGameDataKey) where TDefinition : StaticGameDataDefinition
	{
		...
		if (dictionary.TryGetValue(staticGameDataKey.Id, out TDefinition value))
		{
			return value;
		}
		throw new KeyNotFoundException($"{typeof(TDefinition).Name} with Id {staticGameDataKey.Id} not found");
	}
	...
	{
		return Content.LoadAsync(this.onManifestLoaded<T>, manifestContentKey);
	}
