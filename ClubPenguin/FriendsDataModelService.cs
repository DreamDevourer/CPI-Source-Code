...
public class FriendsDataModelService : AbstractDataModelService, IFriendEvents
{
	...
	public static List<DataEntityHandle> FriendsList => new List<DataEntityHandle>(Service.Get<CPDataEntityCollection>().GetEntitiesByType<FriendData>());

	public static List<DataEntityHandle> IncomingInvitationsList => new List<DataEntityHandle>(Service.Get<CPDataEntityCollection>().GetEntitiesByType<IncomingFriendInvitationData>());

	public static List<DataEntityHandle> OutgoingInvitationsList => new List<DataEntityHandle>(Service.Get<CPDataEntityCollection>().GetEntitiesByType<OutgoingFriendInvitationData>());
	...
	{
		if (dataEntityCollection.TryFindEntity<DisplayNameData, string>(exFriend.DisplayName.Text, out DataEntityHandle dataEntityHandle))
		{
	...
	{
		if (dataEntityCollection.TryFindEntity<DisplayNameData, string>(displayName, out DataEntityHandle dataEntityHandle) && dataEntityCollection.TryGetComponent(dataEntityHandle, out IncomingFriendInvitationData _))
		{
	...
	{
		if (dataEntityCollection.TryFindEntity<DisplayNameData, string>(displayName, out DataEntityHandle dataEntityHandle) && dataEntityCollection.TryGetComponent(dataEntityHandle, out OutgoingFriendInvitationData _))
		{
