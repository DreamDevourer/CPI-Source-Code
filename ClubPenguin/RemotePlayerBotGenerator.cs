...
public class RemotePlayerBotGenerator : MonoBehaviour
{
	...
	public int BotsLeftToSpawn => botsLeftToSpawn;

	public int SpawnDelayCounter => spawnDelayCounter;
	...
	private void checkPosition()
	{
		if (FollowPlayer)
		{
			base.transform.position = ClubPenguin.SceneRefs.ZoneLocalPlayerManager.LocalPlayerGameObject.transform.position;
		}
	}
	...
	{
		LastSessionID++;
		string name = BotName + LastSessionID.ToString();
	...
	public void OnDrawGizmos()
	{
		...
		Vector3 to = vector;
		for (f = 0.1f; f < 6.28318548f; f += 0.1f)
		{
	...
	private static void initialize()
	{
		...
		generator.transform.position = ClubPenguin.SceneRefs.ZoneLocalPlayerManager.LocalPlayerGameObject.transform.position;
	}
