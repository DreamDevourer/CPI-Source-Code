...
public class ModelRenderer
{
	...
	private Transform createModelRenderGameObject()
	{
		...
		gameObject.name = modelRendererCount.ToString() + " " + config.ObjectToRenderTransform.gameObject.name;
	...
	private void placeObjectSoItIsVisibleInCamera()
	{
		...
		float a = 2f * Mathf.Atan2(y, x) * 180f / 3.14159274f;
		float b = 2f * Mathf.Atan2(y2, x) * 180f / 3.14159274f;
