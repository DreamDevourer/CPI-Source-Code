...
public class MixCreateController : AbstractCreateController
{
	...
	public override bool IsOnline => Service.Get<ConnectionManager>().ConnectionState == ConnectionManager.NetworkConnectionState.BasicConnection;

	public override bool IsConfigReady => !loginService.RegistrationConfigIsNotSet;
