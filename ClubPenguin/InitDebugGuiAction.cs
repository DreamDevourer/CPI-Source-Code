...
public class InitDebugGuiAction : InitActionComponent
{
	...
	public static bool ShowDebugGUI
	{
		get
		{
			return Service.Get<Canvas>().GetComponentInChildren<DebugGui>(includeInactive: true).gameObject.activeSelf;
		}
		set
		{
			Service.Get<Canvas>().GetComponentInChildren<DebugGui>(includeInactive: true).gameObject.SetActive(value);
		}
	}
