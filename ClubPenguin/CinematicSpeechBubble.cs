...
public class CinematicSpeechBubble : MonoBehaviour
{
	...
	public DCinematicSpeech SpeechData => speechData;
	...
	private IEnumerator setVisibleAfterFrame()
	{
		...
		setSpeechBubbleVisible(visible: true);
	}
	...
	private bool onMascotAudioComplete(QuestEvents.MascotAudioComplete evt)
	{
		...
		{
			ContinueImage.gameObject.SetActive(value: true);
		}
		return false;
	}
	...
	private void handleButtons()
	{
		...
		{
			ButtonParentTransform.gameObject.SetActive(value: true);
		...
		{
			ButtonParentTransform.gameObject.SetActive(value: false);
		}
	}
