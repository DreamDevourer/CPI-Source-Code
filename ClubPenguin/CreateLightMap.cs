...
public class CreateLightMap : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		Assert.IsFalse(base.gameObject.isStatic, $"GameObject {base.name} cannot be marked as static because it is used to create the dynamic lightmap.");
		storeFieldIDHashes();
		...
		if (!(bool)lightmapCreationMaterial)
		{
