...
public class MiniGamePlayCountData : ScopedData
{
	...
	public Dictionary<string, int> MinigamePlayCounts => minigamePlayCounts;

	protected override string scopeID => CPDataScopes.Session.ToString();

	protected override Type monoBehaviourType => typeof(MiniGamePlayCountDataMonoBehaviour);
