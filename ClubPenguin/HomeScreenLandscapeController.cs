...
public class HomeScreenLandscapeController : HomeScreenController
{
	...
	private IEnumerator precacheBundles()
	{
		...
		yield return new WaitForSeconds((float)(double)bundlePrecacheManager.Config.BundlePrecacheSeconds);
		precacheComplete();
	}
	...
	private void onSettingsButtonClicked()
	{
		...
		{
			settingsPanel = Object.Instantiate(SettingsPrefab, popupCanvas, worldPositionStays: false);
