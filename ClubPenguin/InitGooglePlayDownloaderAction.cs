// InitGooglePlayDownloaderAction
using ClubPenguin;
...
public class InitGooglePlayDownloaderAction : InitActionComponent
{
	...
	private bool useOBB()
	{
		...
		if (configurator.IsSystemEnabled("SKU"))
		{
			...
			if (sKUDictionaryFromSystemDictionary.TryGetValue("UseAPKExpansionFiles", out object value))
			{
				return (bool)value;
			}
		}
	...
	private void showPrompt(string bodyText, bool showButton = true)
	{
		...
		PermissionPrompt.SetActive(value: true);
	}
