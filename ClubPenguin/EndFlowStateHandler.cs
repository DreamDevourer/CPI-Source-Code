...
public class EndFlowStateHandler : AbstractAccountStateHandler
{
	...
	public void OnStateChanged(string state)
	{
		...
		if (sessionManager.HasSession)
		{
			...
			if (!cPDataEntityCollection.TryGetComponent(cPDataEntityCollection.LocalPlayerHandle, out ProfileData component) || !cPDataEntityCollection.TryGetComponent(cPDataEntityCollection.LocalPlayerHandle, out MembershipData _))
			{
				return;
			}
			bool flag = true;
			...
			if (cPDataEntityCollection.TryGetComponent(cPDataEntityCollection.LocalPlayerHandle, out LocalPlayerInZoneData _))
			{
