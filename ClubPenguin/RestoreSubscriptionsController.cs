// RestoreSubscriptionsController
using ClubPenguin;
...
public class RestoreSubscriptionsController : MonoBehaviour
{
	...
	private void onRestoreSuccess()
	{
		...
		Service.Get<EventDispatcher>().DispatchEvent(new PopupEvents.ShowPopup(popup, destroyPopupOnBackPressed: true, scaleToFit: true, "Accessibility.Popup.Title.RestoreSubscriptionSuccess"));
	}
