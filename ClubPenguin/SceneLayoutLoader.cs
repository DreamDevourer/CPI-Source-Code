...
internal class SceneLayoutLoader : MonoBehaviour
{
	...
	{
		applyLighting();
		if (musicDefs.TryGetValue(layout.MusicTrackId, out MusicTrackDefinition value))
		{
	...
	{
		if (lightingDefs.TryGetValue(layout.LightingId, out LightingDefinition value))
		{
	...
	private IEnumerator processMusic(MusicTrackDefinition music)
	{
		...
		if (request.Asset != null)
		{
			...
			string eventName = $"Play/{music.InternalName}";
