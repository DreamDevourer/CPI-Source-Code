...
public sealed class WhirlpoolDigest : IDigest, IMemoable
{
	...
	{
		return (((long)buffer[startPos] & 255L) << 56) | (((long)buffer[startPos + 1] & 255L) << 48) | (((long)buffer[startPos + 2] & 255L) << 40) | (((long)buffer[startPos + 3] & 255L) << 32) | (((long)buffer[startPos + 4] & 255L) << 24) | (((long)buffer[startPos + 5] & 255L) << 16) | (((long)buffer[startPos + 6] & 255L) << 8) | ((long)buffer[startPos + 7] & 255L);
	}
	...
	private void processBlock()
	{
		...
		for (int j = 1; j <= 10; j++)
		{
			...
			for (int k = 0; k < 8; k++)
			{
				...
				array[num] = (l[(long)intPtr] ^ C0[(int)(_K[k & 7] >> 56) & 0xFF]);
				long[] array2 = l = _L;
				int num2 = k;
				intPtr = (IntPtr)num2;
				array2[num2] = (l[(long)intPtr] ^ C1[(int)(_K[(k - 1) & 7] >> 48) & 0xFF]);
				long[] array3 = l = _L;
				int num3 = k;
				intPtr = (IntPtr)num3;
				array3[num3] = (l[(long)intPtr] ^ C2[(int)(_K[(k - 2) & 7] >> 40) & 0xFF]);
				long[] array4 = l = _L;
				int num4 = k;
				intPtr = (IntPtr)num4;
				array4[num4] = (l[(long)intPtr] ^ C3[(int)(_K[(k - 3) & 7] >> 32) & 0xFF]);
				long[] array5 = l = _L;
				int num5 = k;
				intPtr = (IntPtr)num5;
				array5[num5] = (l[(long)intPtr] ^ C4[(int)(_K[(k - 4) & 7] >> 24) & 0xFF]);
				long[] array6 = l = _L;
				int num6 = k;
				intPtr = (IntPtr)num6;
				array6[num6] = (l[(long)intPtr] ^ C5[(int)(_K[(k - 5) & 7] >> 16) & 0xFF]);
				long[] array7 = l = _L;
				int num7 = k;
				intPtr = (IntPtr)num7;
				array7[num7] = (l[(long)intPtr] ^ C6[(int)(_K[(k - 6) & 7] >> 8) & 0xFF]);
				long[] array8 = l = _L;
				int num8 = k;
				intPtr = (IntPtr)num8;
				array8[num8] = (l[(long)intPtr] ^ C7[(int)_K[(k - 7) & 7] & 0xFF]);
			}
			...
			for (int m = 0; m < 8; m++)
			{
				...
				array9[num9] = (l[(long)intPtr] ^ C0[(int)(_state[m & 7] >> 56) & 0xFF]);
				long[] array10 = l = _L;
				int num10 = m;
				intPtr = (IntPtr)num10;
				array10[num10] = (l[(long)intPtr] ^ C1[(int)(_state[(m - 1) & 7] >> 48) & 0xFF]);
				long[] array11 = l = _L;
				int num11 = m;
				intPtr = (IntPtr)num11;
				array11[num11] = (l[(long)intPtr] ^ C2[(int)(_state[(m - 2) & 7] >> 40) & 0xFF]);
				long[] array12 = l = _L;
				int num12 = m;
				intPtr = (IntPtr)num12;
				array12[num12] = (l[(long)intPtr] ^ C3[(int)(_state[(m - 3) & 7] >> 32) & 0xFF]);
				long[] array13 = l = _L;
				int num13 = m;
				intPtr = (IntPtr)num13;
				array13[num13] = (l[(long)intPtr] ^ C4[(int)(_state[(m - 4) & 7] >> 24) & 0xFF]);
				long[] array14 = l = _L;
				int num14 = m;
				intPtr = (IntPtr)num14;
				array14[num14] = (l[(long)intPtr] ^ C5[(int)(_state[(m - 5) & 7] >> 16) & 0xFF]);
				long[] array15 = l = _L;
				int num15 = m;
				intPtr = (IntPtr)num15;
				array15[num15] = (l[(long)intPtr] ^ C6[(int)(_state[(m - 6) & 7] >> 8) & 0xFF]);
				long[] array16 = l = _L;
				int num16 = m;
				intPtr = (IntPtr)num16;
				array16[num16] = (l[(long)intPtr] ^ C7[(int)_state[(m - 7) & 7] & 0xFF]);
			}
		...
		for (int n = 0; n < 8; n++)
		{
			...
			array17[num17] = (l[(long)intPtr] ^ (_state[n] ^ _block[n]));
		}
	}
	...
	private void finish()
	{
		...
		int num = _bufferPos++;
		IntPtr intPtr = (IntPtr)num;
		array2[num] = (byte)(buffer[(long)intPtr] | 0x80);
		if (_bufferPos == _buffer.Length)
		{
			processFilledBuffer();
		}
