...
public class PkixNameConstraintValidator
{
	...
	private string StringifyIPCollection(ISet ips)
	{
		...
		while (enumerator.MoveNext())
		{
			str = str + StringifyIP((byte[])enumerator.Current) + ",";
		}
		if (str.Length > 1)
		{
	...
	public override string ToString()
	{
		...
		{
			str += "DN:\n";
			str = str + permittedSubtreesDN.ToString() + "\n";
		}
		if (permittedSubtreesDNS != null)
		{
			str += "DNS:\n";
			str = str + permittedSubtreesDNS.ToString() + "\n";
		}
		if (permittedSubtreesEmail != null)
		{
			str += "Email:\n";
			str = str + permittedSubtreesEmail.ToString() + "\n";
		}
		if (permittedSubtreesURI != null)
		{
			str += "URI:\n";
			str = str + permittedSubtreesURI.ToString() + "\n";
		}
		if (permittedSubtreesIP != null)
		{
			str += "IP:\n";
			str = str + StringifyIPCollection(permittedSubtreesIP) + "\n";
		}
		str += "excluded:\n";
		if (!excludedSubtreesDN.IsEmpty)
		{
			str += "DN:\n";
			str = str + excludedSubtreesDN.ToString() + "\n";
		}
		if (!excludedSubtreesDNS.IsEmpty)
		{
			str += "DNS:\n";
			str = str + excludedSubtreesDNS.ToString() + "\n";
		}
		if (!excludedSubtreesEmail.IsEmpty)
		{
			str += "Email:\n";
			str = str + excludedSubtreesEmail.ToString() + "\n";
		}
		if (!excludedSubtreesURI.IsEmpty)
		{
			str += "URI:\n";
			str = str + excludedSubtreesURI.ToString() + "\n";
		}
		if (!excludedSubtreesIP.IsEmpty)
		{
			str += "IP:\n";
			str = str + StringifyIPCollection(excludedSubtreesIP) + "\n";
		}
		return str;
	}
}
