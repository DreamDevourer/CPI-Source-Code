...
public class CategoryManager : MonoBehaviour
{
	...
	private void Awake()
	{
		allCategoryButton.SetActive(value: false);
		if (equippedCategoryButton != null)
		{
			equippedCategoryButton.SetActive(value: false);
		}
		if (hiddenCategoryButton != null)
		{
			hiddenCategoryButton.SetActive(value: false);
		}
	...
	private void initAllButton()
	{
		...
		allCategoryButton.SetActive(value: true);
	}
	...
	private void initEquippedButton()
	{
		if (equippedCategoryButton != null)
		{
			...
			equippedCategoryButton.SetActive(value: true);
		}
	}
	...
	private void initHiddenButton()
	{
		if (hiddenCategoryButton != null)
		{
			...
			hiddenCategoryButton.SetActive(value: true);
		}
	}
