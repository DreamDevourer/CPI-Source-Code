...
public class MarketplaceEventRowItem : MonoBehaviour
{
	...
	{
		setCollectWaitVisible(collectWaitVisible: true);
		item.CollectItemSucceeded += onCollectItemSucceeded;
	...
	{
		setCollectWaitVisible(collectWaitVisible: false);
	}
	...
	private void showMemberStatus()
	{
		...
		{
			MemberLockPanel.SetActive(value: true);
		}
		else
		{
			MemberLockPanel.SetActive(value: false);
		}
	}
