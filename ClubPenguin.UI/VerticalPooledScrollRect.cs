...
public class VerticalPooledScrollRect : AbstractPooledScrollRect
{
	...
	protected override float rectSize => base.rectTransform.rect.height;

	protected override float position => scrollRect.content.anchoredPosition.y;

	protected override float sizeDelta => scrollRect.content.sizeDelta.y;
