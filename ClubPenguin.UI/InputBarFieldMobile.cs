...
public class InputBarFieldMobile : InputBarField
{
	...
	public override void Clear()
	{
		...
		setMessageTextActive(isActive: false);
		updateText("");
	}
	...
	private void checkPlaceholderVisibility()
	{
		...
		{
			setMessageTextActive(isActive: true);
		}
		else
		{
			setMessageTextActive(isActive: false);
