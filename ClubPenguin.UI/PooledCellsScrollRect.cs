...
public class PooledCellsScrollRect : AbstractPooledScrollRect
{
	...
	protected override float rectSize => base.rectTransform.rect.width;

	protected override float position => scrollRect.content.anchoredPosition.x;

	protected override float sizeDelta => scrollRect.content.sizeDelta.x;
