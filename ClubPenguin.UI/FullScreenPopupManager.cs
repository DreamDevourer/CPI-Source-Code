...
public class FullScreenPopupManager : MonoBehaviour
{
	...
	public void Awake()
	{
		...
		ClubPenguin.SceneRefs.FullScreenPopupManager = this;
	}
	...
	public void OnDestroy()
	{
		...
		{
			if (cleaners.TryGetValue(cleaner.Key, out ResourceCleaner value))
			{
				value.OnDestroyCallback = null;
			}
		}
		cleaners.Clear();
		ClubPenguin.SceneRefs.FullScreenPopupManager = null;
	}
