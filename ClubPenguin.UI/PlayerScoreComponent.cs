...
public class PlayerScoreComponent : MonoBehaviour
{
	...
	private void onPunchScaleComplete()
	{
		...
		ScoreText.CrossFadeAlpha(0f, num, ignoreTimeScale: true);
		ScoreTextShadow.CrossFadeAlpha(0f, num, ignoreTimeScale: true);
	}
	...
	private void onParticleLoaded(string path, GameObject prefab)
	{
		...
		gameObject.transform.SetParent(playerScoreObject.transform, worldPositionStays: false);
