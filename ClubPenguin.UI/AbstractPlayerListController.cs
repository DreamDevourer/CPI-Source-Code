...
public abstract class AbstractPlayerListController : MonoBehaviour
{
	...
	public void Hide()
	{
		pooledScrollRect.gameObject.SetActive(value: false);
	}
	...
	private List<string> getPlayerSwids()
	{
		...
		{
			if (dataEntityCollection.TryGetComponent(allPlayersList[i], out SwidData component) && !string.IsNullOrEmpty(component.Swid))
			{
