...
public class SuperSpringController : MonoBehaviour
{
	...
	private LocomotionEventBroadcaster LocomotionEventBroadcaster
	{
		get
		{
			...
			{
				locomotionEventBroadcaster = ClubPenguin.SceneRefs.ZoneLocalPlayerManager.LocalPlayerGameObject.GetComponent<LocomotionEventBroadcaster>();
			}
	...
	private int hasEquippedProp()
	{
		bool flag = false;
		int result = -1;
		PropUser component = ClubPenguin.SceneRefs.ZoneLocalPlayerManager.LocalPlayerGameObject.GetComponent<PropUser>();
		if (component != null && component.Prop != null)
		{
			...
			if (flag)
			{
				Animator componentInParent = ClubPenguin.SceneRefs.ZoneLocalPlayerManager.LocalPlayerGameObject.GetComponentInParent<Animator>();
