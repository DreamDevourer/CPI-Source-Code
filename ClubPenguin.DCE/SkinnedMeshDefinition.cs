...
public class SkinnedMeshDefinition : MeshDefinition
{
	...
	{
		return string.Format("[SkinnedMesh] '{0}' RootBone={1}, #BoneNames={2}, Mesh: {3} [{4:x8}]", Name, RootBoneName, (BoneNames != null) ? BoneNames.Length.ToString() : "-", (Mesh != null) ? Mesh.name : "-", (Mesh != null) ? ClubPenguin.DCE.MeshExtensions.GetHash(Mesh) : 0);
	}
