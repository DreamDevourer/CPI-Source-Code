...
public class X509V2AttributeCertificateGenerator
{
	...
	public IEnumerable SignatureAlgNames => Org.BouncyCastle.X509.X509Utilities.GetAlgNames();
	...
	public IX509AttributeCertificate Generate(ISignatureFactory signatureCalculatorFactory)
	{
		...
		asn1EncodableVector.Add(attributeCertificateInfo, (AlgorithmIdentifier)signatureCalculatorFactory.AlgorithmDetails);
		try
		{
			asn1EncodableVector.Add(new DerBitString(((IBlockResult)streamCalculator.GetResult()).Collect()));
