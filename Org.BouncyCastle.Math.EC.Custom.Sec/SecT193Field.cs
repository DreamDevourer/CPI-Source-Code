...
internal class SecT193Field
{
	...
	public static void Reduce63(ulong[] z, int zOff)
	{
		...
		array2[zOff] = (array[(long)intPtr] ^ (num2 ^ (num2 << 15)));
		ulong[] array3 = array = z;
		int num3 = zOff + 1;
		intPtr = (IntPtr)num3;
		array3[num3] = (array[(long)intPtr] ^ (num2 >> 49));
		z[zOff + 3] = (num & 1);
	}
	...
	protected static void ImplMulwAcc(ulong x, ulong y, ulong[] z, int zOff)
	{
		...
		IntPtr intPtr = (IntPtr)zOff;
		array3[zOff] = (array2[(long)intPtr] ^ (num3 & 0x1FFFFFFFFFFFF));
		ulong[] array4 = array2 = z;
		int num6 = zOff + 1;
		intPtr = (IntPtr)num6;
		array4[num6] = (array2[(long)intPtr] ^ ((num3 >> 49) ^ (num2 << 15)));
	}
