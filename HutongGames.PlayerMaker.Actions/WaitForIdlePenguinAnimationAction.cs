// WaitForIdlePenguinAnimationAction
using ClubPenguin;
...
[HutongGames.PlayMaker.Tooltip("Waits until the Penguin Animator Returns To Idle. You might need a wait prior to this in case the animator's state is in idle when this action executes.")]
