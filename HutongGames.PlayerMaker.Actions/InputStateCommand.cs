...
{
	[HutongGames.PlayMaker.Tooltip("Interact Button has been clicked by the player.")]
	public FsmEvent InteractEvent;

	[HutongGames.PlayMaker.Tooltip("Action 1 Button has been clicked by the player.")]
	public FsmEvent Action1Event;

	[HutongGames.PlayMaker.Tooltip("Action 2 Button has been clicked by the player.")]
	public FsmEvent Action2Event;

	[HutongGames.PlayMaker.Tooltip("Action 3 Button has been clicked by the player.")]
	public FsmEvent Action3Event;

	[HutongGames.PlayMaker.Tooltip("Jump Button has been clicked by the player.")]
	public FsmEvent JumpEvent;

	[HutongGames.PlayMaker.Tooltip("The player has steered the joystick.")]
	public FsmEvent SteerEvent;

	public FsmBool FindComponentsOnParent = false;

	[HutongGames.PlayMaker.Tooltip("Cancel input event from the local player")]
